...
from mjrl.algos.sac import SAC
...
if __name__ == '__main__':
    ...
    assert any([job_data['algorithm'] == a for a in ['NPG', 'BCRL', 'DAPG', 'SAC']])
    ...
    rl_agent = SAC(e, policy, baseline, demo_paths,
                    ...
                    value_lr=job_data['value_lr'], sac_updates=job_data['sac_updates']
                   )
