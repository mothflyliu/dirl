"""
This is a job script for running NPG/DAPG/TIRL on hand tasks and other gym envs.
"""
...
from mjrl.algos.GAILlast import GAIL
from mjrl.algos.dnpg import DNPG
...
if __name__ == '__main__':
    ...
    output_location = './bgdnpg150'
    config_file_path = 'bgdnpg.txt'
    # 将存储结果的位置赋给 JOB_DIR
    ...
    # 创建行为克隆代理
    bc_agent = BC(demo_paths, policy=policy, epochs=job_data['bc_epochs'], batch_size=job_data['batch_size'],
    ...
    if job_data['eval_rollouts'] >= 1:
        ...
        print("Score with BC = %f" % score[0][0])
    ...
    agent = DNPG(e, policy, baseline, demo_paths,
                 normalized_step_size=job_data['rl_step_size'],
                 seed=job_data['seed'], save_logs=True,
                 lam_0=job_data['lam_0'], lam_1=job_data['lam_1'],
                 )
    # 创建行为克隆代理
    GAIL_agent = GAIL(demo_paths, policy=policy, discriminator=D, epochs=job_data['ga_epochs'], seed=job_data['seed'],
                      batch_size=job_data['batch_size'], lr=job_data['ga_learn_rate'], loss_type='MSE',
                      ...
                      save_freq=job_data['save_freq'], evaluation_rollouts=job_data['eval_rollouts'],
                      )
    # 计算转换参数
    ...
    rl_agent = DNPG(e, policy, baseline, demo_paths,
                    normalized_step_size=job_data['rl_step_size'],
                    seed=job_data['seed'], save_logs=True,
                    lam_0=job_data['lam_0'], lam_1=job_data['lam_1'],
                    )
