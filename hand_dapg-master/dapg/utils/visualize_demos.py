...
USAGE:\n
    ...
    E:/university/university/laster1/hand_dapg-master/dapg/demonstrations/'+env_name+'_demos.pickle
'''
...
def main(env_name):
    if env_name is "":
        print("Unknown env.")
        return
    demos = pickle.load(open('E:/university/university/laster1/hand_dapg-master/dapg/demonstrations/'+env_name+'_demos.pickle', 'rb'))
