...
from mjrl.algos.model_accel.nn_dynamics import DynamicsNet
...
e = GymEnv(ENV_NAME)
e.set_seed(SEED)
models = [DynamicsNet(state_dim=e.observation_dim, act_dim=e.action_dim, seed=SEED+i, **job_data)
...
for outer_iter in range(job_data['num_iter']):
    ...
    if job_data['refresh_fit']:
        models = [DynamicsNet(state_dim=e.observation_dim, act_dim=e.action_dim, seed=SEED+123*outer_iter,
